...
<script type="text/javascript">
		function result() {
			...
			opener.document.fr.address.value = document.nfr.address1.value+"/"
			+document.nfr.address2.value+"/"
			+document.nfr.address3.value+"/"
			+document.nfr.address4.value+"/"
			+document.nfr.address5.value;
			nfr.submit();
			window.close();
		}
	</script>
...
<body>
<form action="addressCheck.jsp" method="post" name="nfr">
	...
	<input type="button" value="저장" onclick="result();">
</form>
